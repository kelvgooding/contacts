...
count = 0
user = os.getlogin()
path = fr"C:\Users\{user}\Dropbox\Dev\Python\Projects\Contacts"
db = "contacts.db"
icon = "icon-contacts.ico"

# Database Connection

connection = sqlite3.connect(os.path.join(path, f'db/{db}'))
...
root.iconbitmap(os.path.join(path, f'UI/{icon}'))
